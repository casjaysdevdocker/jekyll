...
ARG BUILD_DATE="Fri Sep  1 01:57:49 PM EDT 2023"
...
ENV RUBYOPT=-W0 \
  ...
  BUNDLE_HOME=/usr/local/share/bundler \
  BUNDLE_APP_CONFIG=/usr/local/share/bundler \
  BUNDLE_BIN=/usr/local/bin \
  GEM_BIN=/usr/local/bin \
  GEM_HOME=/usr/local/share/gem \
  JEKYLL_VAR_DIR=/var/jekyll \
  JEKYLL_DATA_DIR=/usr/local/share/jekyll \
  JEKYLL_BIN=/usr/local/bin \
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/jekyll" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/jekyll" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/jekyll" \
  org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/jekyll" \
